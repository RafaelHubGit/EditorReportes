...
import { Card, Button, Space, Typography, Dropdown, Checkbox, Tag, type MenuProps } from 'antd';
import {
    EditOutlined,
    CopyOutlined,
    FolderOutlined,
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <Space size={8} style={{ marginTop: 4 }}>
                            ...
                            {doc.is_draft && <Tag color="blue" style={{ fontSize: 11, lineHeight: '18px' }}>Borrador</Tag>}
                            {doc.is_production && <Tag color="green" style={{ fontSize: 11, lineHeight: '18px' }}>Producción</Tag>}
                            {doc.is_qa && <Tag color="orange" style={{ fontSize: 11, lineHeight: '18px' }}>QA</Tag>}
                        </Space>
                    </div>
